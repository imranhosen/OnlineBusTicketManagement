...
<link rel="stylesheet" href="vallenato/vallenato.css" type="text/css" media="screen" charset="utf-8">
	...
	<!--sa calendar-->	
		...
		function initialiseInputs() {
				// Clear any old values from the inputs 
...
<div id="wrapper">
    ...
    <div id="featured">
        <div id="items">
            ...
            <p><a href="#"><strong>Daffodil Bus</strong><br />
            ...
            <p><a href="lodging.php"><strong>From shukrabad to Uttara</strong><br />
			Spend a relaxing evening in our Bus</a></p>  
			</div>
	...
	<div id="footer">
	<h4>+8801798659099 &bull; <a href="contact.php">Subhanbagh,Dhanmondi-32,Dhaka</a></h4>
	<p>Daffodil &nbsp;&nbsp;&bull;&nbsp;&nbsp;Mon - Sun: 10:00 am - 12:00 am</p>
	<a href="index.php"><img src="xres/images/footer-logo.jpg" alt="" /></a>
	<p>&copy; Copyright 2016 Daffodil Bus | All Rights Reserved <br /></p>
</div>
</div>
</body>
</html>
